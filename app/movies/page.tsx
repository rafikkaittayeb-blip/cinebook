                  ...
                  <div className="movie-card bg-[#111] border border-[#2a2a2a] rounded-xl overflow-hidden h-full flex flex-col">
                    ...
                    <div className="relative aspect-[2/3] overflow-hidden bg-[#1a1a1a]">
                      ...
                      <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        <span className="flex items-center gap-2 px-5 py-2.5 bg-yellow-500 text-black font-bold rounded-lg text-sm">
                    ...
                    <div className="p-4 flex flex-col gap-3 flex-1">
                      <div>
                        <h3 className="font-serif font-bold text-white text-lg leading-tight group-hover:text-yellow-400 transition-colors">
                          {movie.title}
                        </h3>
                      ...
                      <div className="flex items-center justify-between mt-auto pt-3 border-t border-[#1e1e1e]">
                        ...
                        <span className="text-xs text-gray-500 group-hover:text-yellow-400 transition-colors flex items-center gap-1">
