...
const MOVIES = [
  ...
  },
  {
    ...
    poster: 'https://upload.wikimedia.org/wikipedia/en/5/52/Saltburn_Film_Poster.jpg',
    backdrop: 'https://upload.wikimedia.org/wikipedia/en/5/52/Saltburn_Film_Poster.jpg',
    language: 'English',
    price: 80,
